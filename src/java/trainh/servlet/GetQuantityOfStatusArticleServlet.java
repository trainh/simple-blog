 ...
 * @author trainh
 */
@WebServlet(name = "GetQuantityOfStatusArticleServlet", urlPatterns = {"/GetQuantityOfStatusArticleServlet"})
public class GetQuantityOfStatusArticleServlet extends HttpServlet {
